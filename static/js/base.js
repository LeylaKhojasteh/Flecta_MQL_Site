...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const mobileNavigationOverlay = document.getElementById(
    ...
    function openMobileMenu() {
        ...
        mobileNavigationOverlay.classList.add("is-visible");

        mobileMenuButton.setAttribute("aria-expanded", "true");
        mobileNavigation.setAttribute("aria-hidden", "false");
        mobileNavigationOverlay.setAttribute("aria-hidden", "false");
    ...
    function closeMobileMenu() {
        ...
        mobileNavigationOverlay.classList.remove("is-visible");

        mobileMenuButton.setAttribute("aria-expanded", "false");
        mobileNavigation.setAttribute("aria-hidden", "true");
        mobileNavigationOverlay.setAttribute("aria-hidden", "true");
    ...
    if (mobileNavigationOverlay) {
        mobileNavigationOverlay.addEventListener(
            "click",
            closeMobileMenu
        );
    }
